<{include file="public/header.tpl"}>	
	<div id="top">
			...
			<div class="right_user">
				<b>欢迎您-</b><a title="<{$smarty.session.description}>" target="_top" href="<{$root}>/index.php/user/index/uid/<{$smarty.session.id}>"><{ $smarty.session.username }></a>&nbsp;【<{$smarty.session.groupdis}>】 &nbsp;&nbsp;
			</div>
		</div>
