				...
				<ul class="viewmess">
					<li class="light-row">
						<span class="col_width">公告标题<span class="red_font">*</span></span>
						 <input type="text" class="text-box" name="title" maxlength="80" size="40" value="<{ $post.title }>">&nbsp;<{$color}>可以为标题选择颜色
					</li>
					<li class="dark-row">
					...
					<li class="dark-row">
						...
						<span style="float:left;height:150px;;width:530px"><textarea class="text-box" name="content" cols="50" rows="5"><{ $post.content }></textarea>
						<{$ck}>
						</span>
					</li>
