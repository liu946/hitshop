			...
			<div class="msg-box">
				<ul class="viewmess">
					...
					<li class="dark-row">
						...
						<input name="userpwd" type="password"  value="<{if $post.srcpwd eq null}>hitshop<{else}><{$post.srcpwd}><{/if}>" class="text-box"> 
						初使密码为hitshop
					</li>
					<li class="light-row">
						<span class="col_width">确认密码<span class="red_font">*</span></span>
						<input name="repwd" type="password"  value="<{if $post.srcpwd eq null}>hitshop<{else}><{$post.srcpwd}><{/if}>"  size="20" class="text-box">
					</li>
					<li class="dark-row">
